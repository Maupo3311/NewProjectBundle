...
use NewProjectBundle\Services\CoordinateService;
 ...
 *
 * @ORM\Table(name="shop")
 * @ORM\Entity(repositoryClass="NewProjectBundle\Repository\ShopRepository")
 */
class Shop
{
    /**
     ...
     *
     * @ORM\OneToMany(
     *     targetEntity="NewProjectBundle\Entity\Image\ShopImage",
     *      cascade={"persist","remove"},
     *      orphanRemoval=true,
     *      mappedBy="shop"
     * )
