...
use NewProjectBundle\Entity\Image\FeedbackImage;
use NewProjectBundle\Repository\FeedbackRepository;
 ...
 * @ORM\Entity(repositoryClass="NewProjectBundle\Repository\FeedbackRepository")
...
class Feedback
{
     ...
     *
     * @ORM\OneToMany(
     *     targetEntity="NewProjectBundle\Entity\Image\FeedbackImage",
