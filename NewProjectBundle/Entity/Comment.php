...
use NewProjectBundle\Entity\Image\CommentImage;
 ...
 * @ORM\Entity(repositoryClass="NewProjectBundle\Repository\CommentRepository")
 */
class Comment
{
    /**
     ...
     *
     * @ORM\OneToMany(
     *     targetEntity="NewProjectBundle\Entity\Image\CommentImage",
